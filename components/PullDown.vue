...
<script>
    ...
    // labels of pull down
    const LABELS = ['Something Went Wrong!', 'Pull down to refresh', 'Release to refresh', 'Data refreshing...'];
...
.pull-down-container {
 ...
 .pull-down-content--icon.pull-down-error {
	 background: url("~assets/img/error-icon.png") no-repeat center center;
	 background-size: 20px 20px;
}
